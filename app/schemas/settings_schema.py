...
class SettingsPayload(BaseModel):
    ...
    date_format: str = Field(default="YYYY-MM-DD HH:mm", max_length=40)
    session_timeout_minutes: str = Field(default="480", max_length=20)
    default_parallel_workers: str = Field(default="2", max_length=20)
    retry_failed_tests: str = Field(default="false", max_length=10)
    max_retry_count: str = Field(default="1", max_length=20)
    auto_open_latest_report: str = Field(default="false", max_length=10)
    mask_sensitive_data: str = Field(default="true", max_length=10)
    audit_retention_days: str = Field(default="90", max_length=20)
    reports_retention_days: str = Field(default="180", max_length=20)
    default_report_formats: str = Field(default="html,excel,pdf", max_length=120)
