async function loadProjects() {
  ...
  tbody.innerHTML = rows.map(item => `
    <tr>
      ...
      <td><button class="btn secondary" onclick="deleteProject(${item.id})">Eliminar</button></td>
...
async function saveProject(event) {
  ...
  try {
    await apiPost("/api/projects", {
      ...
      default_browser: form.get("default_browser"),
